...
public class LogcatActivity extends AppCompatActivity {
    ...
    private com.swrevo.logcatviewer.databinding.ActivityLogcatBinding mBinding;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mBinding = com.swrevo.logcatviewer.databinding.ActivityLogcatBinding.inflate(getLayoutInflater());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == android.R.id.home) {
            ...
            @SuppressLint("StaticFieldLeak") ExportLogFileTask task = new ExportLogFileTask(getExternalCacheDir()) {
                @Override
