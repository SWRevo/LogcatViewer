...
public class LogItem implements Parcelable {
    ...
    LogItem(String line) throws IllegalStateException, ParseException {
        ...
        time = new SimpleDateFormat("MM-dd hh:mm:ss.SSS", Locale.getDefault()).parse(Objects.requireNonNull(timeText));
        processId = Integer.parseInt(Objects.requireNonNull(pidText));
        threadId = Integer.parseInt(Objects.requireNonNull(tidText));
        priority = tagText;
        tag = prefixText;
        content = contentText;
        origin = line;
